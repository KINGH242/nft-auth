      ...
      <div className="container mrgnbtm">
        <div className="layoutRow">
          ...
          <div className="col-md-5">
            <EndpointCheck getEndpoints={disEndpoints}></EndpointCheck>
          </div>
          <div className="col-md-5">
            <MintToken
              mintToken={mintTokenF}
              instanceIDF={instanceID}
            ></MintToken>
          </div>
          <div className="col-md-5">
            <ActivateWallet activateWallet={activateWalletF}></ActivateWallet>
          </div>
